...
public class LoginController {
    ...
    public ResponseEntity<?> login(@RequestBody LoginRequestDTO loginRequest, HttpServletResponse response) {
        ...
        if (isValidUser) {
            ...
            empCodeCookie.setDomain("3.34.95.178:5173");
            ...
            empNameCookie.setDomain("3.34.95.178:5173");
            ...
            empImgCookie.setDomain("3.34.95.178:5173");
            ...
            empaAuthCodeCookie.setDomain("3.34.95.178:5173");
